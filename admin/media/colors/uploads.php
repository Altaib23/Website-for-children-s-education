...
<body>
    ...
    <!-- Navbar End -->
		<div class="card">
			<center>
				<h3 class="text-primary">الالوان</h3>
			</center>
			<hr />
			<div class="row">
				<?php
				include "../database.php";
				$sql = "SELECT * FROM colors ORDER BY dongID DESC Limit 20";
				...
				?>
						<div class="col-md-3 raised">
							...
							<a href="download.php?music=<?php echo $row['dongID']; ?>" style="text-decoration: none;" class="text-center">
