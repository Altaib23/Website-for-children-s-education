...
{    
	...
	//Song File
	$song_file = "realsoundz_com_".rand(1000,1000000)."_".$_FILES['song_file']['name'];
	...
	{
		$sql = "INSERT INTO shapes (songName, songUploader, songCover, songFile, songSize, songDate)
		VALUES ('$song_name', '$song_uploader', '$final_cover', '$final_song', '$new_size', '$date');";
