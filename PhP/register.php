...
<body style="background-image: url(i1.jpg);background-repeat: no-repeat;background-size: cover;">
	...
	<label style="color:white">Name</label><br>
	 ...
	 <input type="text" name="ph" class="form-control" required="" placeholder="Phone"><br>
	  ...
	  <input type="submit" name="ch"  value="Add" class="btn-success">
	  	...
	  	$sql="insert into donator(donator_name,donator_gender,donator_email,donator_phone,donator_nation) values ('$Name','$Gender','$email','$phone','$Nation')";
